...
public class CreepoakwoodBlock extends HypercraftModElements.ModElement {
	@ObjectHolder("hypercraft:creepoakwood")
	public static final Block block = null;
	public CreepoakwoodBlock(HypercraftModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.7f, 5f).lightValue(0));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("creepoakwood");
		}
